...
class CheatPatchTests(unittest.TestCase):
    def document(self, source: bytes) -> dict:
        return {
            ...
            "observations": [
                {"event": "First player death", "before": "3", "after": "2", "emulator": "Elkulator"},
                {"event": "Second player death", "before": "2", "after": "1", "emulator": "Elkulator"},
            ],
            "hardwareProfile": {"machine": "electron", "tube": False},
        }
