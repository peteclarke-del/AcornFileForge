...
METAINFO = ROOT / "packaging/linux/uk.co.acornfileforge.AcornFileForge.metainfo.xml"


class VersionTests(unittest.TestCase):
    def test_packaged_version_matches_stable_release(self):
        self.assertEqual(application_version(), "1.1.3")
    ...
    def test_this_release_has_notes_linked_from_the_documentation_index(self):
        ...
        self.assertTrue(
            notes.read_text(encoding="utf-8").startswith(
                f"# Acorn File Forge {application_version()}\n"
            ),
