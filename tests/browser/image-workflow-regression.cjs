...
(async () => {
  ...
  try {
    ...
    console.log("Generated MMB, checkpoint, undo, operation and save browser regression passed");
  } finally {
    if (imageId) {
