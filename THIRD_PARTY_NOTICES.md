...
Acorn File Forge source is distributed under the MIT License in
...
| Gunicorn | 23.0.0 | MIT | <https://github.com/benoitc/gunicorn> |
...
| Playwright | 1.58.2, development and browser tests | Apache-2.0 | <https://github.com/microsoft/playwright> |
...
obligations beyond those of the Acorn File Forge source repository.

## Firmware and ROM material

Files under `firmware/` are not covered by the Acorn File Forge MIT licence.
...
ROMs, disk images, tapes, archives and hard-drive images opened or downloaded
by a user retain the rights of their original authors and publishers. Acorn
