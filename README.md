...
```bash
sudo apt install ./acorn-file-forge_1.1.1-1~deb13_amd64.deb
acorn-file-forge
```
...
The current stable release is `1.1.1`. It provides the editing and
...
```json
{"engine":"oaknut","status":"ok","version":"1.1.1"}
```
