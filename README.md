...
The current stable release is `1.1.3`. It provides the editing and
...
The released Oaknut 12.17.1 engine safely edits ADFS S, M, L and D, New-map E,
...
```json
{"engine":"oaknut","status":"ok","version":"1.1.3"}
```
...
- Flask 3.1
- Gunicorn 26
- Oaknut Disc, ADFS and ROMFS 12.17.1, including writable FileCore
