...
The current stable release is `1.2.1`. It provides the editing and
...
The released Oaknut 12.18.2 engine safely edits ADFS S, M, L and D, New-map E,
...
and **Restart Acorn File Forge** starts it. Working images and preferences are
...
```json
{"engine":"oaknut","status":"ok","version":"1.2.1"}
```
...
- Flask 3.1
- Gunicorn 26
- Oaknut Disc, ADFS and ROMFS 12.18.2, including writable FileCore
