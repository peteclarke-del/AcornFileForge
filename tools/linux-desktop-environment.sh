...
acorn_prepare_desktop_environment() {
    webkit_fallback=${ACORN_FILE_FORGE_DISABLE_WEBKIT_SANDBOX:-auto}
    case $webkit_fallback in
        ...
        auto)
            ...
            ;;
        *)
            echo "ACORN_FILE_FORGE_DISABLE_WEBKIT_SANDBOX must be auto, 0 or 1." >&2
            return 2
            ;;
    esac
