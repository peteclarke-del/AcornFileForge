...
Acorn File Forge can inspect one tokenised BBC BASIC or machine-code file for
...
The binary pass uses the same profile-aware 6502, 65C02, 65816, ARM or 68000
disassembly as the file editor. It looks for:
...
restart behaviour. The [StarDot game disassembly discussion](https://stardot.org.uk/forums/viewtopic.php?t=23155)
contains a concrete example. The [8-Bit Software catalogue](https://8bs.com/catalogue/tmu.htm)
also indexes contemporary magazine cheat programs for many titles.
