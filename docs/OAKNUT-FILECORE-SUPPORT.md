...
Acorn File Forge uses the released Oaknut 12.16.0 packages. No local Oaknut
patch is applied at build time.

Oaknut 12.16.0 incorporates the writable classic E/F work and supplies one
...
same 12.16.0 release. The Docker dependency stage imports the public ADFS format
