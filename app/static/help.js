      ...
      <div class="help-layout">
        ...
        <div class="help-content">
          ...
          <section id="help-desktop">
            ...
            <div class="help-warning"><strong>Updating:</strong> install a newer <code>.deb</code> over the release package, or pull the new source and rerun the checkout installer when Python dependencies change. Working sessions remain under <code>~/.local/share/acorn-file-forge</code>, or the configured XDG data directory.</div>
          </section>
          ...
          <section id="help-limits">
            ...
            <ul>
              <li>The released Oaknut 12.16.0 engine safely creates and edits ADFS S/M/L/D/E/E+/F/F+/G/G+, old-map and new-map FileCore hard disks, and BeebSCSI old-map DAT with its matching DSC.</li>
            ...
            <dl>
              ...
              <dt>A FileCore image cannot be opened</dt><dd>Confirm it is a raw ADFS/FileCore image or a supported HDF/HD4 layout rather than a compressed archive or track dump. The Docker build pins Oaknut 12.16.0 and needs no local patch. The detailed error distinguishes an unrecognised filesystem from a corrupt map or directory.</dd>
