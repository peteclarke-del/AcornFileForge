        ...
        <div class="help-content">
          ...
          <section id="help-analysis">
            ...
            <div class="help-task"><h4>Audit a collection</h4><ol>
              <li>Choose <strong>Collection</strong> in the application header, or <strong>Library → Private collection</strong> in a pane, to open this browser profile's persistent catalogue. Add an open image with an optional SD-card label, NAS path or physical location and its target machines. The catalogue stores complete manifests and hashes in IndexedDB, never image bytes on the server.</li>
              ...
              <li><strong>Export report</strong> downloads the current findings. <strong>Back up database</strong> retains complete versioned records and the wanted list; Import can merge or replace after bounded validation. Remove selected and Clear catalogue affect only this browser's index, not images or recoverable sessions.</li>
